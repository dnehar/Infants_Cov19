...
# colors  
  col_SCs <- c('CD4_SC0'='tomato',
              'CD4_SC1'='paleturquoise',
              'CD4_SC2'='cornflowerblue',
              'CD4_SC3'='mediumseagreen',
              'CD4_SC4'='mediumpurple',
              'CD4_SC5'='goldenrod') #'B_cells_SC6'='lightgreen'
              
# CD4 T cell subsets 

 subset_to_be_plotted <- c("CD4_SC0", paste0("CD4_SC",seq(1:5)))
...
# order names 
 pHC <-  paste0("pHC", seq(1:14))
  ...
  BP <- Meta %>% 
    ...
    ylab('% in CD4 T cells') + xlab('Individuals (n=40)')
